...
export default function QuoteRecordPDF({ quote }: QuoteRecordPDFProps) {
  const company = quote.Company || {}
  const customer = quote.Deal?.Customer || {}
    ...
    <Document>
      <Page size="A4" style={styles.page}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerRight}>
              ...
              <Text style={styles.recordNumber}>
                Kayıt No: {quote.id.substring(0, 8)}
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.card}>
            ...
            {formattedValidUntil && (
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{formattedValidUntil}</Text>
              </View>
            )}
            <View style={styles.infoRow}>
          ...
          {/* Ürün/Hizmet Listesi */}
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Ürün/Hizmet Listesi</Text>
