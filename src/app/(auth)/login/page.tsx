                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-blue-900 mb-1">Demo Hesabı</p>
                        <p className="text-xs text-blue-700">
                          Test için demo hesabı kullanabilirsiniz. Şifre: <code className="font-mono bg-white px-1.5 py-0.5 rounded border border-blue-200">demo123</code>
                        </p>
                      </div>
                    </div>
                  </motion.div>
