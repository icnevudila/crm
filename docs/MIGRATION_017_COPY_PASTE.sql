-- ============================================
-- MIGRATION 017 - CUSTOMER COMPANY UPGRADE
-- ============================================
...
-- 2. ÖNCE mevcut verileri güncelle (NULL veya geçersiz status değerlerini 'POT' yap)
UPDATE "CustomerCompany"
SET status = 'POT'
WHERE status IS NULL OR status NOT IN ('POT', 'MUS', 'ALT', 'PAS');

-- 3. Status ENUM kontrolü için CHECK constraint (veriler güncellendikten sonra)
ALTER TABLE "CustomerCompany"
...
-- 6. Trigger: lastMeetingDate güncelleme
